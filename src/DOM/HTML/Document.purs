...
foreign import _activeElement :: forall eff. Document -> Eff (dom :: DOM | eff) (Nullable HTMLElement)

activeElement :: forall eff. HTMLDocument -> Eff (dom :: DOM | eff) -> Eff (Maybe HTMLElement)
